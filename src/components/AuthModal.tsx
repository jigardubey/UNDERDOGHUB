        ...
        {authMode === 'login' && (
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="relative my-4 flex items-center justify-center">
              ...
              <span className="relative bg-[#12131A] px-3 text-[10px] text-gray-400 uppercase font-bold">OR</span>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white text-xs font-bold flex items-center justify-center gap-2 transition-all"
            >
